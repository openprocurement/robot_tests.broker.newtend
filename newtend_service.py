...
bin/openprocurement_tests -s openProcedure -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:tender_owner --outputdir ~/Documents/robot_artifacts/other_tender_owner
bin/openprocurement_tests -s auction -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:tender_owner --outputdir ~/Documents/robot_artifacts/other_tender_owner
bin/openprocurement_tests -s qualification -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:tender_owner --outputdir ~/Documents/robot_artifacts/other_tender_owner
bin/openprocurement_tests -s contract_signing -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:tender_owner --outputdir ~/Documents/robot_artifacts/other_tender_owner

bin/openprocurement_tests -s openProcedure -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:provider
bin/openprocurement_tests -s auction -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:provider
bin/openprocurement_tests -s qualification -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:provider
bin/openprocurement_tests -s contract_signing -A robot_tests_arguments/dgf_other.txt -v BROKER:Newtend -v ROLE:provider
